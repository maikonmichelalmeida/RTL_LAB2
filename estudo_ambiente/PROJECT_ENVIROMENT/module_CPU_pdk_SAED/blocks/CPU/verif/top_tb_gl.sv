...
// =========================================================
  // FSDB Dump Configuration (Verdi/Power Analysis)
  // =========================================================
initial begin
      // Define o nome do arquivo de saída
      $fsdbDumpfile("top_rtl.fsdb"); 
      
      // 0 = Grava toda a hierarquia (testbench e DUT)
      // top_tb_gl = O nome do seu módulo de testbench
      $fsdbDumpvars(0, top_tb_gl);
      
      // Opcional: Se você tiver memórias ou arrays multidimensionais
      // $fsdbDumpMDA(); 
end
